...
#       01_orthomcl.py
#===============================================================================
from protsuite import Proteome
...
cloptions.add_option('-f', '--arrangment2family', dest = 'arrangment2family',
    ...
    default = '/home/f_zimm01/Dropbox/uni/Master/FM_1_TF/data/input/arrangement2family')
...
cloptions.add_option('-o', '--organisms', dest = 'organisms',
    ...
    default = '/home/f_zimm01/Dropbox/uni/Master/FM_1_TF/data/input/speciesMapping')    
